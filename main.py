...
from SimulationResultWidget import SimulationResultWidget
import sys
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.simulation_result_widget = SimulationResultWidget()
        self.bot_selector_widget = BotSelectorWidget(self.data_plotter_widget, self.simulation_result_widget)
        ...
        layout.addWidget(self.simulation_result_widget, 1, 1)
